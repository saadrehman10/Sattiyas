        ...
        <div>
          ...
          <section className="cs_slider position-relative">
            ...
            <div className="container">
              <div className="cs_section_heading cs_style_1">
                <div className="cs_section_heading_in">
                  <h2 className="cs_section_title cs_fs_50 cs_bold mb-0">Best selling product</h2>
                </div>
            ...
            <div className="container-fluid">
              <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                <div className="cs_slider_wrapper">
                  <div className="slick_slide_in">
                    <div className="cs_product cs_style_1 cs_bordered">
                      <div className="cs_product_thumb position-relative">
                        {/* <img src="assets/img/product4.png" alt="Product Image" className="w-100"> */}
                        <div className="cs_cart_badge position-absolute">
                          <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-heart"></i>
                          </a>
                          <a href="product_details.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-eye"></i>
                          </a>
                        </div>
                        <a href="cart.html" className="cs_cart_btn cs_accent_bg cs_fs_16 cs_white_color cs_medium position-absolute"> Add To Cart</a>
                      </div>
                      <div className="cs_product_info text-center">
                        ...
                        <p className="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$250.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_product cs_style_1 cs_bordered">
                      <div className="cs_product_thumb position-relative">
                        {/* <img src="assets/img/product5.png" alt="Product Image" className="w-100"> */}
                        <div className="cs_cart_badge position-absolute">
                          <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-heart"></i>
                          </a>
                      ...
                      <div className="cs_product_info text-center">
                        ...
                        <p className="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$220.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_product cs_style_1 cs_bordered">
                      <div className="cs_product_thumb position-relative">
                        {/* <img src="assets/img/product6.png" alt="Product Image" className="w-100"> */}
                        <div className="cs_cart_badge position-absolute">
                          <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-heart"></i>
                          </a>
                        ...
                        <a href="cart.html" className="cs_cart_btn cs_accent_bg cs_fs_16 cs_white_color cs_medium position-absolute">
                          Add To Cart</a>
                      </div>
                      <div className="cs_product_info text-center">
                        <h3 className="cs_product_title cs_fs_21 cs_medium">
                        ...
                        <p className="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$350.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_product cs_style_1 cs_bordered">
                      <div className="cs_product_thumb position-relative">
                        {/* <img src="assets/img/product7.png" alt="Product Image" className="w-100"> */}
                        <div className="cs_cart_badge position-absolute">
                          <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-heart"></i>
                          </a>
                  ...
                  <div className="slick_slide_in">
                    <div className="cs_product cs_style_1 cs_bordered">
                      <div className="cs_product_thumb position-relative">
                        {/* <img src="assets/img/product16.png" alt="Product Image" className="w-100"> */}
                        <div className="cs_cart_badge position-absolute">
                          <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                            <i className="fa-regular fa-heart"></i>
                          </a>
          ...
          <div className="row cs_gap_y_24">
            <div className="col-sm-6">
              <div className="cs_category cs_style_1">
                <a href="shop.html" className="cs_category_thumb position-relative">
                  {/*  <img src="assets/img/men2.jpg" alt="Category Image" className="w-100"> */}
            ...
            <div className="col-sm-6">
              <div className="cs_category cs_style_1">
                <a href="shop.html" className="cs_category_thumb position-relative">
                  {/* <img src="assets/img/women2.jpg" alt="Category Image" className="w-100"> */}
                  <span className="cs_category_btn">
                    <span>Women</span>
                    <span><i className="fa-solid fa-arrow-right"></i></span>
                  </span>
            ...
            <div className="col-sm-6">
              <div className="cs_category cs_style_1">
                <a href="shop.html" className="cs_category_thumb position-relative">
                  {{/* <img src="assets/img/kid1.jpg" alt="Category Image" className="w-100"> */ }}
                  <span className="cs_category_btn">
                    <span>Kids</span>
                    <span><i className="fa-solid fa-arrow-right"></i></span>
                  </span>
            ...
            <div className="col-sm-6">
              <div className="cs_category cs_style_1">
                <a href="shop.html" className="cs_category_thumb position-relative">
                  {/*  <img src="assets/img/children2.jpg" alt="Category Image" className="w-100"> */}
                  <span className="cs_category_btn">
                    <span>Children</span>
                    <span><i className="fa-solid fa-arrow-right"></i></span>
                  </span>
          ...
          <section>
            ...
            <div className="container">
              <div className="text-center">
                <h2 className="cs_section_title cs_fs_50 cs_bold mb-0">New items in store</h2>
              </div>
              <div className="cs_height_63 cs_height_lg_35"></div>
              <div className="cs_isotope_filter cs_style_1">
                <ul className="cs_mp0">
                  <li><a href="#" data-filter=".t_shirt" className="cs_fs_16 cs_medium">T-shirt</a></li>
                  <li><a href="#" data-filter=".jeans" className="cs_fs_16 cs_medium">Jeans</a></li>
                  <li><a href="#" data-filter=".c_shirt" className="cs_fs_16 cs_medium">Casual shirt</a></li>
                  <li><a href="#" data-filter=".leggings" className="cs_fs_16 cs_medium">Leggings</a></li>
                  <li><a href="#" data-filter=".skirt" className="cs_fs_16 cs_medium">Skirt</a></li>
                  <li><a href="#" data-filter=".shoes" className="cs_fs_16 cs_medium">Shoes</a></li>
                  <li><a href="#" data-filter=".accessories" className="cs_fs_16 cs_medium">Accessories</a></li>
                </ul>
              </div>
            </div>
            <div className="container-fluid">
              <div className="cs_isotope cs_style_1 cs_isotope_col_4 cs_has_gutter_24">
                <div className="cs_grid_sizer"></div>
                <div className="cs_isotope_item t_shirt shoes">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product1.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-25%</div>
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                        </a>
                ...
                <div className="cs_isotope_item t_shirt leggings">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product2.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-8%</div>
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                        </a>
                ...
                <div className="cs_isotope_item t_shirt accessories skirt">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product3.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-12%</div>
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                        </a>
                ...
                <div className="cs_isotope_item t_shirt leggings skirt">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product16.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-8%</div>
                ...
                <div className="cs_isotope_item accessories c_shirt shoes jeans">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product8.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                        </a>
                ...
                <div className="cs_isotope_item c_shirt leggings jeans">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/*  <img src="assets/img/product9.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-8%</div>
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                ...
                <div className="cs_isotope_item skirt leggings c_shirt">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/* <img src="assets/img/product10.png" alt="Product Image" className="w-100">     */}
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                        </a>
                ...
                <div className="cs_isotope_item c_shirt shoes accessories jeans">
                  <div className="cs_product cs_style_1 cs_bordered">
                    <div className="cs_product_thumb position-relative">
                      {/*  <img src="assets/img/product11.png" alt="Product Image" className="w-100"> */}
                      <div className="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-12%</div>
                      <div className="cs_cart_badge position-absolute">
                        <a href="wishlist.html" className="cs_cart_icon cs_accent_bg cs_white_color">
                          <i className="fa-regular fa-heart"></i>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 align-items-center">
                    <div className="cs_card_info">
                      <h2 className="cs_card_title cs_fs_50 cs_bold">Winter jacket limited time offer 40%</h2>
          ...
          <div className="cs_height_140 cs_height_lg_80"></div>
          <div className="container">
            <div className="cs_slider">
              <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="2000" data-center="0"
                data-slides-per-view="responsive" data-xs-slides="2" data-sm-slides="3" data-md-slides="3" data-lg-slides="4" data-add-slides="5">
                <div className="cs_slider_wrapper">
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
                      {/*  <img src="assets/img/brand_1.svg" alt="Partner Logo"> */}
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
                      {/*  <img src="assets/img/brand_2.svg" alt="Partner Logo"> */}
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
                      {/*  <img src="assets/img/brand_3.svg" alt="Partner Logo"> */}
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
                      {/* <img src="assets/img/brand_4.svg" alt="Partner Logo"> */}
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
                      {/* <img src="assets/img/brand_5.svg" alt="Partner Logo"> */}
                    </div>
                  </div>
                  <div className="slick_slide_in">
                    <div className="cs_partner_logo">
          ...
          <section className="cs_gray_bg">
            ...
            <div className="cs_slider position-relative">
              <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="1" data-md-slides="1" data-lg-slides="1"
                data-add-slides="1">
                <div className="container">
                  <div className="cs_slider_wrapper">
                    <div className="slick_slide_in">
            ...
            <div className="container">
              <div className="cs_section_heading cs_style_1">
                <div className="cs_section_heading_in">
                  <h2 className="cs_section_title cs_fs_50 cs_bold mb-0">
                    Read our exclusive fashion <br></br> trendy articles</h2>
                </div>
                <div className="cs_hesction_heading_right">
                  <a href="blog.html" className="cs_btn cs_style_1 cs_fs_16 cs_medium">See All Blogs</a>
                </div>
              </div>
              ...
              <div className="row cs_gap_y_30">
                <div className="col-lg-4">
                  <div className="cs_post cs_style_1">
                    <a href="blog_details.html" className="cs_post_thumb cs_zoom">
                      {/*  <img src="assets/img/post1.jpg" alt="Post Image" className="cs_zoom_in w-100"> */}
                    </a>
                    ...
                    <div className="cs_post_info">
                      ...
                      <a href="blog_details.html" className="cs_post_btn cs_fs_16 cs_medium cs_primary_color">
                        <span>Read More</span>
                ...
                <div className="col-lg-4">
                  <div className="cs_post cs_style_1">
                    <a href="blog_details.html" className="cs_post_thumb cs_zoom">
                      {/* <img src="assets/img/post2.jpg" alt="Post Image" className="cs_zoom_in w-100"> */}
                    </a>
                    <div className="cs_post_meta">
                      <p className="cs_post_meta_info mb-0 cs_fs_14">JMARCH 18, 2023</p>
                    </div>
                    <div className="cs_post_info">
                      <h3 className="cs_post_title cs_fs_28 cs_semibold">
                ...
                <div className="col-lg-4">
                  <div className="cs_post cs_style_1">
                    <a href="blog_details.html" className="cs_post_thumb cs_zoom">
                      {/*  <img src="assets/img/post3.jpg" alt="Post Image" className="cs_zoom_in w-100"> */}
                    </a>
                    <div className="cs_post_meta">
                      <p className="cs_post_meta_info mb-0 cs_fs_14">JANUARY 13, 2023</p>
                    </div>
          ...
          <section className="container-fluid">
            ...
            <div className="row cs_gap_y_24">
              <div className="col-xl-3 col-sm-6">
                <div className="cs_iconbox cs_style_1 position-relative">
                  <div className="cs_iconbox_icon cs_primary_color">
                  ...
                  <div className="cs_iconbox_text">
                    <h4 className="cs_iconbox_title cs_fs_21 cs_semibold">Free Shipping</h4>
                    <p className="cs_iconbox_subtitle mb-0">No need to worry about cost</p>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-sm-6">
                <div className="cs_iconbox cs_style_1 position-relative">
                  ...
                  <div className="cs_iconbox_text">
                    <h4 className="cs_iconbox_title cs_fs_21 cs_semibold">Payment Method</h4>
                    <p className="cs_iconbox_subtitle mb-0">Easy and hassle free online transaction</p>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-sm-6">
                <div className="cs_iconbox cs_style_1 position-relative">
                  ...
                  <div className="cs_iconbox_text">
                    <h4 className="cs_iconbox_title cs_fs_21 cs_semibold">Online Support</h4>
                    <p className="cs_iconbox_subtitle mb-0">N24 hours a day, 7 days a week</p>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-sm-6">
                <div className="cs_iconbox cs_style_1 position-relative">
                  ...
                  <div className="cs_iconbox_text">
                    <h4 className="cs_iconbox_title cs_fs_21 cs_semibold">Secure Packaging</h4>
                    <p className="cs_iconbox_subtitle mb-0">Every order packaging securely place</p>
                  </div>
                </div>
              </div>
            </div>
