...
export default function Shop() {
    ...
    const { data, error, isLoading } = useFetch('http://localhost:3100/product/productslist');
        ...
        <>
            <Layout>
                <section
                    ...
                    style={{
                        backgroundImage: `url(https://images.unsplash.com/photo-1560343090-f0409e92791a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8cHJvZHVjdHxlbnwwfHwwfHx8MA%3D%3D)`,
                ...
                >
                    ...
                    <div className="container position-relative">
                        <h2 className="cs_fs_50 cs_bold cs_white_color mb-0">Shop</h2>
                    </div>
                </section>
                <section>
